...
class Website_Crawler_Menu(QDialog):
    ...
    def createGroupBox(self):
        ...
        self.html_to_csv_converter = QPushButton("HTML Tables to CSV Converter")
        self.html_to_csv_converter.setDefault(True)
        ...
        self.links_extractor = QPushButton("Websites Links Extractor")
        self.links_extractor.setDefault(True)
        ...
        self.layout.addWidget(self.html_to_csv_converter)
        self.layout.addWidget(self.email_extractor)
        self.layout.addWidget(self.xss_scanner)
        self.layout.addWidget(self.links_extractor)
    ...
    def retranslateUi(self, Website_Crawler_Menu):
        ...
        if self.language == "English":
            ...
            self.html_to_csv_converter.setText("HTML Tables to CSV Converter")
            self.email_extractor.setText("E-Mail Extractor")
            self.xss_scanner.setText("Cross-Site Scripting (XSS) Scanner (EXPERIMENTAL)")
            self.links_extractor.setText("Websites Links Extractor")
            ...
            self.html_to_csv_converter.setText("Convertitore di tabelle da HTML a CSV")
            ...
            self.links_extractor.setText("Estrattore di Link da Siti Web")
